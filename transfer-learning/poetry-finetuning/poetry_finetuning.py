...
model = LanguageModelingModel('bert', 'bert-large-uncased', args = finetune_args, use_cuda = False) # Highly recommended to set use_cuda = True to ultilize GPU (if available) for training
